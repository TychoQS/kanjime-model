...
if ON_KAGGLE:
    ...
    PREDICTION_FOLDER = '/kaggle/input/tests-images/inference_samples'
    ...
    PREDICTION_FOLDER = '../inference_samples'
    CASIA_HWDB_DATASET_SAMPLES_PATH = "../data/chinese-handwriting/CASIA_HWDB_SAMPLES"
    FONT_PATH = '../resources/fonts/Noto_Sans_JP/static/NotoSansJP-Regular.ttf'
